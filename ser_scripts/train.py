...
def train_model(learning_rate, epochs, batch_size):
    ...
    for epoch in range(epochs):
        ...
        list_of_accuracy_values += [val_acc]
        if list_of_accuracy_values[epoch] > list_of_accuracy_values[epoch-1]:
            exp_highest_acc = val_acc
            most_acc_model = model_load(learning_rate)[0].state_dict()
